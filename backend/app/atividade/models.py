from sqlalchemy import MetaData,String,DateTime,UUIDType,ForeignKey,LargeBinary
...
class Atividade(Base):
    ...
    status: Mapped[StatusAtividade] = mapped_column(SQLEnum(StatusAtividade),default=StatusAtividade.PROVISORIA) 
    ...
    registro_presenca:Mapped[list["Presenca"]]=relationship(back_populates="atividade", cascade="all, delete-orphan")
